...
namespace CRIMAS.SupportClasses
{
    ...
    {
        public static MvcHtmlString ActionButton(this HtmlHelper html, string linkText, string action, string controllerName, string iconClass, string anchorClass)
        {
            ...
            lAnchorBuilder.MergeAttribute("class", anchorClass);
